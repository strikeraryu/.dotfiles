return {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>wr", "<cmd>AutoSession restore<CR>", vim.tbl_extend("force", opts, {
        desc = "Restore session for cwd",
      }))
      vim.keymap.set("n", "<leader>wl", "<cmd>AutoSession save<CR>", vim.tbl_extend("force", opts, {
        desc = "Save session for root dir",
      }))
      vim.keymap.set("n", "<C-s>", "<cmd>AutoSession search<CR>", vim.tbl_extend("force", opts, {
